...
public sealed class GetContextPackTool(ILuthnClient client) : ILuthnMcpTool
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await client.GetContextPackAsync(coreTags, maxItems, query, cancellationToken);
    }
