(() => {
  ...
  const resources = {
    en: {
      ...
      "mode.transportDisconnected": "Configured — not connected",
      "mode.transportStale": "Connection expired",
      "mode.transportRevoked": "Connection revoked",
      "mode.transportReady": "Connected",
    ...
    ko: {
      ...
      "mode.transportDisconnected": "설정됨 — 연결 대기",
      "mode.transportStale": "연결 만료",
      "mode.transportRevoked": "연결 철회됨",
      "mode.transportReady": "연결됨",
