(() => {
  ...
  const resources = {
    en: {
      ...
      "orientation.stepAccessBody": "Personal Local mode starts a bounded session automatically. Enrolled installations require Cloud login.",
      ...
      "auth.serviceTitle": "Personal Local = automatic session",
      ...
      "auth.scopeNote": "LocalAuto is available only for an un-enrolled SingleOwner installation bound to loopback. Cloud mode requires login.",
    ...
    ko: {
      ...
      "orientation.stepAccessBody": "개인 로컬 모드는 제한된 세션을 자동으로 시작합니다. 등록된 설치는 Cloud 로그인이 필요합니다.",
      ...
      "auth.scopeNote": "LocalAuto는 미등록 SingleOwner 설치가 루프백에 바인딩된 경우에만 사용할 수 있습니다. Cloud 모드는 로그인이 필요합니다.",
