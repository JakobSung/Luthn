(() => {
  ...
  const resources = {
    en: {
      ...
      "auth.scopeNote": "LocalAuto is available from this screen only for an un-enrolled SingleOwner installation bound to loopback. Cloud mode requires login.",
    ...
    ko: {
      ...
      "auth.scopeNote": "LocalAuto는 이 화면에서 미등록 SingleOwner 설치가 루프백에 바인딩된 경우에만 연결할 수 있습니다. Cloud 모드는 로그인이 필요합니다.",
