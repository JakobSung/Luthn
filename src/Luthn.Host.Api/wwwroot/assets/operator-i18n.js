(() => {
  ...
  const resources = {
    en: {
      ...
      "auth.scopeNote": "LocalAuto is available only for a SingleOwner installation bound to loopback. Authorize the browser with the installed `luthn console` command first.",
    ...
    ko: {
      ...
      "auth.scopeNote": "LocalAuto는 루프백에 바인딩된 SingleOwner 설치에서만 사용할 수 있습니다. 먼저 이 컴퓨터에서 `luthn console` 명령으로 브라우저를 승인해야 합니다.",
