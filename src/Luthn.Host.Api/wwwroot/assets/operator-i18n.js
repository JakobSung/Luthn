(() => {
  ...
  const resources = {
    en: {
      ...
      "orientation.stepAccessBody": "Run luthn console to authorize one bounded Personal Local session. Enrolled installations require Cloud login.",
      ...
      "auth.scopeNote": "LocalAuto requires luthn console and is available only for an un-enrolled SingleOwner installation bound to loopback. Cloud mode requires login.",
    ...
    ko: {
      ...
      "orientation.stepAccessBody": "luthn console을 실행하면 개인 로컬 세션 하나를 제한된 시간 동안 승인합니다. 등록된 설치는 Cloud 로그인이 필요합니다.",
      ...
      "auth.scopeNote": "LocalAuto는 luthn console 실행이 필요하며 미등록 SingleOwner 설치가 루프백에 바인딩된 경우에만 사용할 수 있습니다. Cloud 모드는 로그인이 필요합니다.",
